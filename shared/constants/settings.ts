...
QUEUE_RECALL_LIMIT: 'queue.recallLimit',
  QUEUE_EXPIRE_AFTER_SKIPS: 'queue.expireAfterSkips',
...
{
    key: SETTING_KEYS.QUEUE_EXPIRE_AFTER_SKIPS,
    label: 'Nomor hangus setelah terlewat',
    help: 'Nomor yang sudah dilewati sebanyak ini otomatis hangus dan pengunjung harus mengambil nomor baru. 0 mematikan aturan ini. Bisa ditimpa per event.',
    group: 'queue',
    type: 'number',
    default: 3,
    min: 0,
    max: 20,
    unit: 'nomor',
    eventOverride: 'expireAfterSkips',
  },
  {
